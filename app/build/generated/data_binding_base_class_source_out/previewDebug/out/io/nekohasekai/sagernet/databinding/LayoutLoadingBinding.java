...
public final class LayoutLoadingBinding implements ViewBinding {
  ...
  private LayoutLoadingBinding(@NonNull LinearLayout rootView, @NonNull TextView loadingText) {
  ...
  public static LayoutLoadingBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new LayoutLoadingBinding((LinearLayout) rootView, loadingText);
    }
