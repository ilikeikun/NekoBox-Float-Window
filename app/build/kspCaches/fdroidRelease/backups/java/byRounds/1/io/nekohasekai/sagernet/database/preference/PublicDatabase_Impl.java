...
public final class PublicDatabase_Impl extends PublicDatabase {
  ...
  protected Map<Class<?>, List<Class<?>>> getRequiredTypeConverters() {
    ...
    _typeConvertersMap.put(KeyValuePair.Dao.class, KeyValuePair_Dao_PublicDatabase_Impl.getRequiredConverters());
  ...
  public KeyValuePair.Dao keyValuePairDao() {
    if (_keyValuePair != null) {
      ...
      synchronized(this) {
        if(_keyValuePair == null) {
          _keyValuePair = new KeyValuePair_Dao_PublicDatabase_Impl(this);
        }
        return _keyValuePair;
      }
    }
