...
public final class KeyValuePair_Dao_TempDatabase_Impl implements KeyValuePair.Dao {
  ...
  public KeyValuePair_Dao_TempDatabase_Impl(@NonNull final RoomDatabase __db) {
    this.__db = __db;
